...
module.exports = {
	addToBasket: function addToBasket(message, done) {
...
function addItemToBasket(message, callback) {
	try {
		...
		_dbClient2.default.addToBasket(message, function (err, data) {
			var retry = 0;
			if (err) {
				...
				_logger2.default.info("Products Successfully added: Acknowledgement Received from DB service");
